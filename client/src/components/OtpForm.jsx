...
const OtpForm = ({ onVerify }) => {
  ...
  return (
    <div className="bg-slate-900 p-6 rounded-lg shadow-lg w-full max-w-md flex flex-col justify-center align-middle items-center gap-5">
        <p className=" flex gap-5 justify-center align-middle items-center text-md text-gray-400"><MailIcon className="text-2xl text-default-400 pointer-events-none flex-shrink-0" /> Enter OTP sent to the given mail.</p>
        <form>
